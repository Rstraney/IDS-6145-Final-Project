...
## Discussion
Initially, we hypothesized that the two modes of transportation that were the most efficient for theme park visitors were Disney's monorails and buses. However, based on our results we have concluded that the most efficient mode of transportation are the Disney buses. We did not measure safety or satisfaction directly even though these were interesting aspects to investigate. For our model we focused on investigating the time of arrival. From our results, we found that the although buses ran most frequently in comparison to the other modes of transportation, they did not carry as many passengers. Choosing to take the bus as a guest will reduce the amount of travel time, however from a corporate perspective it is not as efficient as the other modes of transportation.
